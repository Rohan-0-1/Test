      ...
      <div
        ...
        className={`group flex items-center px-4 py-3 rounded-xl transition-all duration-300 hover-lift
          ${isActive(item.href) 
            ...
            : 'hover:glass-dark hover:text-white'
          }
        ...
        <GlassCard className="h-full rounded-none lg:rounded-r-3xl" background="glass-dark" padding="p-0">
          <div className="h-full flex flex-col text-white">
            ...
            <div className="border-t border-white/10 p-4">
              ...
              <Link to="/">
                <div
                  className={`group flex items-center px-4 py-3 rounded-xl hover:bg-red-500/20 
                ...
                >
                  ...
                  {isSidebarOpen && (
                    <span className="ml-3 text-red-400 group-hover:text-red-300 font-medium transition-colors duration-300">
                      Logout
                    </span>
                  )}
                </div>
